    ...
    <>
      ...
      <div class="navbar bg-base-100">
        <div class="flex-1">
          ...
          <div><label for="my-drawer-3" aria-label="open sidebar" class="tooltip tooltip-bottom" data-tip="View all Pages"><Icon class="mr-2" icon="pages" width={28} height={28}  /></label></div>
      ...
      <div class="drawer-side z-10">
        ...
        <Icon class="mr-2" icon="shield" width={16} height={16}  />
          ...
          {/* Items below are what pop up inside the View all pages section */}
